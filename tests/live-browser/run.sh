...
go test -count=1 -run '^TestLabelStudioLiveResultBecomesReviewedFinalizedCoreSnapshot$' -timeout 3m -v ./internal/annotation/labelstudio 2>&1 | tee "$ARTIFACTS/label-studio-core-live.log"
