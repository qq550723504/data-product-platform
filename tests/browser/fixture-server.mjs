      ...
      const goldExplanation = {
        ...
        trace: {
          ...
          evidence: [
            ...
            { id: "35353535-3535-4535-8535-353535353535", phase: "DIRECT_DATA", subjectType: "DELIVERY_OPERATION", subjectId: "30303030-3030-4030-8030-303030303030", evidenceType: "DATASET_DELIVERY_ISSUED", relationType: "DELIVERY_EVIDENCE", sourceType: "DELIVERY_OPERATION", hashAlgorithm: "SHA256", hashValue: "3".repeat(64), createdAt: stamp },
          ],
          audit: [
            ...
            { id: "40404040-4040-4040-8040-404040404040", phase: "DIRECT_DATA", objectType: "DELIVERY_OPERATION", objectId: "30303030-3030-4030-8030-303030303030", action: "DATASET_DELIVERY_ISSUED", actorType: "SYSTEM", traceId: "trace-delivery", occurredAt: stamp },
          ],
        },
      };
