...
├── Annotation / Review → Gold Dataset（#204–#207 已实现；#208 自动化纵向与 live Gold UI 已通过，仅剩人工解释验收）
└── External Delivery
~~~
