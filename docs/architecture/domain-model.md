    ...
    DatasetVersion
          ...
          └── DatasetCertification (#134)
             ...
             Certified DatasetVersion
                    ...
                    └── Annotation / Gold Dataset（#204–#207 已实现；#208 自动化 live Pilot 已通过，human acceptance deferred）
~~~
